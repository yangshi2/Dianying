 ...
 * 日期： 2019/11/13 09:14
 */
public class RecyclerMovieDirectorAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<MovieXiangQBean.ResultBean.MovieDirectorBean> datas = new ArrayList<>();
    public RecyclerMovieDirectorAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_director, null);
