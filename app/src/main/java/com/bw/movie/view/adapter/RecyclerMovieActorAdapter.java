 ...
 * 日期： 2019/11/13 09:14
 */
public class RecyclerMovieActorAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<MovieXiangQBean.ResultBean.MovieActorBean> datas = new ArrayList<>();
    public RecyclerMovieActorAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_actor, null);
